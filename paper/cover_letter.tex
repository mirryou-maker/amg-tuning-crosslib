...
the released data, and a companion tool, \texttt{tools/recommend.py}, applies
the predictor to a user's own matrix. We would welcome consideration under the
Replicated Computational Results process.
